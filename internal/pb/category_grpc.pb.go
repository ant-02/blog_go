...
type CategoryServiceClient interface {
	GetAll(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*CategoryListResponse, error)
}
...
func (c *categoryServiceClient) GetAll(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*CategoryListResponse, error) {
...
type CategoryServiceServer interface {
	GetAll(context.Context, *emptypb.Empty) (*CategoryListResponse, error)
...
func (UnimplementedCategoryServiceServer) GetAll(context.Context, *emptypb.Empty) (*CategoryListResponse, error) {
